...
use Bartlett\Reflect\Application\Command\DiagramClassCommand as AppReflectionDiagramCommand;
 ...
 */
class DiagramClassCommand extends AbstractCommand
{
    protected function configure()
    {
        $this->setName('bartlett:diagram:class')
    ...
    {
        $command = new AppReflectionDiagramCommand(
