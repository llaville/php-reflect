<?php
/**
 * Statement represents a node statement of the AST.
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * The Statement class represents a node statement of the AST (Abstract Syntax Tree).
 *
 * @category PHP
 * @package  PHP_Reflect
 * @author   Laurent Laville <pear@laurent-laville.org>
...
{
    /**
     * Ast Statement class constructor
     *
