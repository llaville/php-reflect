<?php
/**
 * Filter values based on include model.
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * Filter out unwanted values, in parse results, based on include model.
 *
 * @category PHP
 * @package  PHP_Reflect
 * @author   Laurent Laville <pear@laurent-laville.org>
 ...
 */
class IncludeFilter extends \FilterIterator implements \Countable
{
    /**
    ...
    public function accept()
    {
        ...
        if ($item instanceof IncludeModel) {
            $accept = true;
        }
        return $accept;
    }
