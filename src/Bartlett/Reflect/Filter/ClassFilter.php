<?php
/**
 * Filter values based on class model.
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
class ClassFilter extends \FilterIterator implements \Countable
{
    /**
     * Class Modifiers that will restrict scope of results
     * @var array
     */
    private $modifiers;
     ...
     * @param array     $modifiers The class modifiers that you want to restrict scope.
     *
     * @return ModelFilter
     */
    public function __construct(\Iterator $iterator, array $modifiers = null)
    {
