...
.v2 deprecated
--
*Last Branch 2 Release* [label label-danger]#{deprecated}#

It was published on {deprecatedPubDate}.

ifdef::basebackend-bootstrap[]
link:./manual/2.6/en/getting-started.html["Learn more",role="primary",icon="glyphicon-book",options="block"]
endif::[]

ifndef::basebackend-bootstrap[]
link:./manual/2.6/en/getting-started.html[Learn more]
endif::[]
--
====
