...
| icon:check[]     | icon:check[]
| *getInterfaceNames* - Gets the interface names       | icon:check[]     | icon:check[]
...
| *getParentClass* - Gets parent class                 | icon:check[]     | icon:check[]
| *getProperties* - Gets properties                    | icon:check[]     | icon:check[]
...
| *getStaticProperties* - Gets static properties       | icon:check[]     | icon:check[]
...
| *hasProperty* - Checks if property is defined        | icon:check[]     | icon:check[]
