...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-3.0.0-beta1.phar
...
[source,bash]
----
$ chmod +x phpreflect-3.0.0-beta1.phar
$ mv phpreflect-3.0.0-beta1.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-3.0.0-beta1.phar
$ php phpreflect-3.0.0-beta1.phar --version
----
...
====
----
phpReflect version 3.0.0-beta1
----
====
