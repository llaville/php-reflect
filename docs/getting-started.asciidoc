...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-4.0.0.phar
...
[source,bash]
----
$ chmod +x phpreflect-4.0.0.phar
$ mv phpreflect-4.0.0.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-4.0.0.phar
$ php phpreflect-4.0.0.phar --version
----
