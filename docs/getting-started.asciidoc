...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-2.6.2.phar
...
[source,bash]
----
$ chmod +x phpreflect-2.6.2.phar
$ mv phpreflect-2.6.2.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-2.6.2.phar
$ php phpreflect-2.6.2.phar --version
----
