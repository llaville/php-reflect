...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-4.2.1.phar
...
[source,bash]
----
$ chmod +x phpreflect-4.2.1.phar
$ mv phpreflect-4.2.1.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-4.2.1.phar
$ php phpreflect-4.2.1.phar --version
----
