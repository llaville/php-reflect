...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-4.0.2.phar
...
[source,bash]
----
$ chmod +x phpreflect-4.0.2.phar
$ mv phpreflect-4.0.2.phar /usr/local/bin/phpreflect
...
$ php phpreflect-4.0.2.phar --version
----
