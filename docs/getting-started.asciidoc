...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-2.6.1.phar
...
[source,bash]
----
$ chmod +x phpreflect-2.6.1.phar
$ mv phpreflect-2.6.1.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-2.6.1.phar
$ php phpreflect-2.6.1.phar --version
----
