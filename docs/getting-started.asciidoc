...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-3.0.0-beta2.phar
...
[source,bash]
----
$ chmod +x phpreflect-3.0.0-beta2.phar
$ mv phpreflect-3.0.0-beta2.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-3.0.0-beta2.phar
$ php phpreflect-3.0.0-beta2.phar --version
----
...
====
----
phpReflect version 3.0.0-beta2
----
====
