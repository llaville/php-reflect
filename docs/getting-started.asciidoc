...
:pharstable:  http://bartlett.laurent-laville.org/get/phpreflect-2.5.0.phar
...
[source,bash]
----
$ chmod +x phpreflect-2.5.0.phar
$ mv phpreflect-2.5.0.phar /usr/local/bin/phpreflect
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-2.5.0.phar
$ php phpreflect-2.5.0.phar --version
----
