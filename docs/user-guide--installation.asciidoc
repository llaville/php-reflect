...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-2.3.0-beta.phar
$ chmod +x phpreflect-2.3.0-beta.phar
$ mv phpreflect-2.3.0-beta.phar /usr/local/bin/phpreflect
$ phpreflect
----
...
----
$ wget http://bartlett.laurent-laville.org/get/phpreflect-2.3.0-beta.phar
$ php phpreflect-2.3.0-beta.phar
----
