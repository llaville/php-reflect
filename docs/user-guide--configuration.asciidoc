...
WARNING: [label label-primary]#Reflect# always needs a JSON file to run.
...
have a look on developer's guide in the link:developer-guide.html#plugins[Plugins] section.

* Want to create a new analyser,
have a look on developer's guide in the link:developer-guide.html#analysers[Analysers] section.
