...
* download the phar version http://bartlett.laurent-laville.org/get/phpreflect-3.1.1.phar[3.1.1]
* install via https://packagist.org/packages/bartlett/php-reflect/[packagist] the current source dev-master or the stable version 3.1.1
