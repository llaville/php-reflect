<?php
/**
 * Unit Test Case that covers AST Node Else Statement.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class ElseAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests the else statement without optional block.
     *
     * <code>
     *  if (expr) 
     *    ...
     ...
     * @return  void
     */
    public function testElseWithoutBlock()
    {
        ...
        $this->assertEquals(
            ...
            'Attributes of Else Statement does not match.'
        );
    }

    /**
     * Tests the else statement with optional block.
     *
     * <code>
     *  if (expr) 
     *    ...
     ...
     * @return  void
     */
    public function testElseWithBlock()
    {
        $nodes = self::$package->getChildren();
        $n     = 2;
