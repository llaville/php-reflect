<?php
/**
 * Unit Test Case that covers AST Node List Statement.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class ListAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests the list statement with all variables assigned.
     *
     * @depends testAstStorage
     * @group   ast
     * @return  void
     */
    public function testListWithAllVariablesAssigned()
    {
        $nodes = array();
        $n     = 0;
        ...
        $this->assertEquals(
            ...
            'Attributes of List Statement does not match.'
        );
    }

    /**
     * Tests the list statement with some variables assigned.
     *
     * @depends testAstStorage
     * @group   ast
     * @return  void
     */
    public function testListWithPartialAssign()
    {
        $nodes = array();
        $n     = 2;
        self::$package->findChildren(
