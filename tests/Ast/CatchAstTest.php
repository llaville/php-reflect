<?php
/**
 * Unit Test Case that covers AST Node Catch Statement.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class CatchAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCatchException()
    {
        ...
        $this->assertEquals(
            ...
            'Attributes of Catch Statement does not match.'
        );
    }
}
