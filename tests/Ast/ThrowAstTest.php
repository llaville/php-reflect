<?php
/**
 * Unit Test Case that covers AST Node Throw Statement.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class ThrowAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThrowErrorException()
    {
        ...
        $this->assertEquals(
            ...
            'Attributes of Throw Statement does not match.'
        );
    }
}
