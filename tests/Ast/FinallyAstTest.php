<?php
/**
 * Unit Test Case that covers AST Node Finally Statement.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class FinallyAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests the finally statement associated to a try/catch.
     *
     * @depends testAstStorage
     * @group   ast
     * @return  void
     */
    public function testFinallyCatchException()
    {
        ...
        $this->assertEquals(
            ...
            'Attributes of Finally Statement does not match.'
        );
    }
}
