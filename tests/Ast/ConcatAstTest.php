<?php
/**
 * Unit Test Case that covers AST Node Concat Expression.
 *
 * PHP version 5
 *
 * @category   PHP
 ...
 * @link       http://php5.laurent-laville.org/reflect/
 */
class ConcatAstTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests the concat expression between a function return and a constant.
     *
     * @depends testAstStorage
     * @group   ast
     * @return  void
     */
    public function testConcatFunctionReturnAndConstant()
    {
        $nodes = array();
        $n     = 0;
        ...
        $this->assertEquals(
            ...
            'Attributes of Concat Expression does not match.'
        );
    }
}
